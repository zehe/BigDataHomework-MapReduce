...
for line in sys.stdin:
    ...
    if pickup_date == current_pickup_date:
        ...
        if current_pickup_date:
            print ("%s\t%.2f,%.2f" % (
                current_pickup_date, current_fare_amount + current_surcharge + current_tip_amount,
                current_tolls_amount))
...
print ("%s\t%.2f,%.2f" % (
    current_pickup_date, current_fare_amount+current_surcharge+current_tip_amount, current_tolls_amount))
